...
Original file is located at
    https://colab.research.google.com/drive/1LeYCER99tVZ9xwQP-SMADbG4YJyfvrmL
"""
...
TrainTest_datadict['D'+str(0)][0].T[0:100].shape
...
accuratepredicts=accurate_predictions(data_train,trained_parameters)
accuratepredicts

def accuracy(accuratepredicts,data):
    print(accuratepredicts/len(data.T.columns)*100)

accuracy(accuratepredicts,data_train)
